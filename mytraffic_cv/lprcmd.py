...
fontC = ImageFont.truetype(fontpath, 20, 0)  # 加载中文字体，20表示字体大小，0表示unicode编码
...
test_dir = "D:/compete/car/1.jpg"

def cartag(Inputpath):
    try:
        image = cv2.imdecode(np.fromfile(Inputpath, dtype=np.uint8), -1)  # 读取图片文件
